...
<div style="width: 1045px;height: 500px">
    ...
    <div style="width: 1045px;height: 40px;margin-top: 20px">
        ...
        <form id="queryForm" style="margin-left: 110px;height: 40px" <%--action="/user/treeList" --%> method="get" >
            <div  style="float: left">
                <%--搜索条件输入框--%>
                <input style="width: 80px;" type="text" class="mio-inp-common search1" name="mioTreeListCustom.name">
    ...
    <div class="mio-shadow" style="z-index: 1000;margin: 0 auto;width: 1045px;margin-left: 110px" >
        ...
        <div id="datagrid1" class="mini-datagrid" style="height: 500px"
             url='/common/tableLists' ajaxType="get" showHeader=false title="MIO" <%--显示表头以及表头命名--%>
        ...
        >
            ...
            <div property="columns">
                ...
                <div field="parentId" width="30" allowSort="true"  align="center" headerAlign="center" >父ID
                ...
                <div field="isParents" <%--renderer="onisParent"--%>  width="60" allowSort="true"  align="center" headerAlign="center" >是否为父节点</div>
                <%--autoShowPopup="true"编辑时是否自动显示下拉框--%>
                <div field="state" autoShowPopup="true" width="40" headerAlign="center"
                     align="center" allowSort="true"  class="test11">状态
                ...
                <div field="attribute" width="50" headerAlign="center" align="center" allowSort="true">地址
                    <input property="editor"  class="mini-textbox" style="width:100%;" minWidth="100" />
                </div>
                <%--时间设置 dateFormat="yyyy-MM-dd HH:mm:ss"--%>
                <div field="created"  dateFormat="yyyy-MM-dd HH:mm:ss" width="80" allowSort="true"  align="center" headerAlign="center" >创建时间</div>
                <div field="updated"  dateFormat="yyyy-MM-dd HH:mm:ss" width="80" allowSort="true"  align="center" headerAlign="center" >更新时间</div>
...
<script type="text/javascript">
    ...
    function searchTable() {
        ...
        $('#queryForm').attr('action','http://localhost:8082/query?q='+$('.search1').val()+'');
