...
<div style="width:100%;height: 100%;padding-top: 4%;">
  ...
  <form  id="mio-loginFrame" method="post" onsubmit="return false;" class="mio-shadow"
      ...
      <div style="border-bottom: 1px solid black;height: 30px;margin-bottom:30px;width: 300px">
          ...
          <span style="float: right;">没有账号 <a href="${basePath}common/user/register" style="color: red;cursor: pointer">立即注册</a></span>
      </div>
      <%--用户名--%>
      ...
      <div class="code" style="display: none">
          <input placeholder="请输入验证码" value="hidden" autocomplete="off" style="width: 300px;margin-bottom: 20px" id="randomcode" name="validateCode" class="mio-inp  mio-code"/>
