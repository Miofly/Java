...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html"><img src="${basePath}images/detail/logo.png" /></a>
                ...
                <li class="notification-dropdown hidden-phone">
                    ...
                    <div class="pop-dialog">
                        ...
                        <div class="body">
                            ...
                            <div class="messages">
                                <a href="#" class="item">
                                    <img src="${basePath}images/detail/contact-img.png" class="display" />
                                ...
                                <a href="#" class="item">
                                    <img src="${basePath}images/detail/contact-img2.png" class="display" />
                                    <div class="name">Alejandra Galván</div>
                                    <div class="msg">
        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="new-user.html">用户表单</a></li>
                    <li><a href="user-profile.html">用户文件</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                            ...
                            <tbody>
                                ...
                                <tr class="first">
                                    <td>
                                        <input type="checkbox" />
                                        <div class="img">
                                            <img src="${basePath}images/detail/table-img.png" />
                                        </div>
    ...
    <script src="${basePath}js/detail/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    <script src="${basePath}js/detail/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="${basePath}js/detail/jquery.flot.js"></script>
    <script src="${basePath}js/detail/jquery.flot.stack.js"></script>
    <script src="${basePath}js/detail/jquery.flot.resize.js"></script>
