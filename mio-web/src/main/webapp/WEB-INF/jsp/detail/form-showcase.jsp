...
<head>
    ...
    <link rel="stylesheet" href="../../WEB-INF/jsp/detail/css/compiled/form-showcase.css" type="text/css" media="screen" />
...
<body>
    ...
    <script src="../../../js/detail/wysihtml5-0.3.0.js"></script>
    <script src="../../../js/detail/jquery-latest.js"></script>
    <script src="../../../js/detail/bootstrap.min.js"></script>
    <script src="../../../js/detail/bootstrap-wysihtml5-0.0.2.js"></script>
    <script src="../../../js/detail/bootstrap.datepicker.js"></script>
    <script src="../../../js/detail/jquery.uniform.min.js"></script>
    <script src="../../../js/detail/select2.min.js"></script>
