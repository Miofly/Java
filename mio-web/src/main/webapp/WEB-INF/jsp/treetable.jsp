...
<div style="width: 1045px;height: 500px">
    ...
    <div class="mio-shadow" style="z-index: 1000;margin: 0 auto;width: 1045px;margin-left: 110px" >
        ...
        <div id="pager1" class="mini-pager" style="width:1045px;height: 30px;
        border: 1px solid rgb(197, 197, 197);border-bottom: none"
             sizeList=[30,60,90,700] pageSizeWidth=58 ></div>
        <%--datagrid--%>
        ...
        >
            ...
            <div property="columns">
                ...
                <div field="isParent" <%--renderer="onisParent"--%>  width="60" allowSort="true"  align="center" headerAlign="center" >是否为父节点</div>
...
setInterval(function(){    },    3000);    /*单个删除*/
    function delRow() {
        /*获取当前行的数据*/
        var row = grid.getSelected();
