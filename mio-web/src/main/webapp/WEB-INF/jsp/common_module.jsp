...
<body style="background: rgba(0,0,0,0.8);position: relative;height: 2000px">
    ...
    <div style="position: absolute;right: 10px;top: 780px;background: cadetblue;width: 300px" onselectstart="return false"<%--禁止左键划字复制功能--%>
        ...
        <%--华文细黑--%>
        <span style="font-family: STXihei;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--冬青黑体--%>
        <span style="font-family: Hiragino Sans GB;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--Safari下默认的字体--%>
        <span style="font-family: Times New Roman;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--微软正黑体 --%>
        <span style="font-family: Microsoft JhengHei;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--仿宋 --%>
        <span style="font-family: FangSong;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--楷体 --%>
        <span style="font-family: KaiTi;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--华文楷体--%>
        <span style="font-family: STKaiti;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--华文仿宋--%>
        <span style="font-family: STFangsong;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--黑体--%>
        <span style="font-family: SimHei;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--微軟正黑體--%>
        <span style="font-family: Microsoft JhengHei;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--隶书--%>
        <span style="font-family: LiSu;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--幼圆--%>
        <span style="font-family: YouYuan;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--华文楷体--%>
        <span style="font-family: STKaiti;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--方正舒体--%>
        <span style="font-family: FZShuTi;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--华文彩云--%>
        <span style="font-family: STCaiyun;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--华文行楷--%>
        <span style="font-family: STXingkai;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
        <%--华文新魏--%>
        <span style="font-family: STXinwei;color: white;margin-top: 10px;font-size:18px;text-align: center;display: block">我的测试字体test font YEs</span>
    </div>
