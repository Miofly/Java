...
public class ResultUtil implements Serializable {
    ...
    /*带data信息的*/
    public static ResultInfo createInfos(String fileName, int messageCode, Object[] objs, Object data) {
        String message = null;
        if (objs == null) {
            message = ResourcesUtil.getValue(fileName, messageCode + "");
        } else {
        ...
        return new ResultInfo(ResultInfo.TYPE_RESULT_SUCCESS, messageCode, message, data);
    }
