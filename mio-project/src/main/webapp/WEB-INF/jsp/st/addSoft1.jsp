...
<body style="width: 100%;background: url(${basePath}images/login.jpg) center center;
	...
	<div style="margin: 30px auto 0">
      ...
      margin-left: 15%;margin-top: -14.5%">SoftWare Admin</span>
		...
		<form id="addSoft" method="post" enctype="multipart/form-data" onsubmit="return false;" class="mio-frame">
			...
			<input name="name" class="mio-inp addName" placeholder="请输入文件名称" style="margin-bottom: 20px;margin-top: 20px;width: 300px"  type="text">
			<span class="glyphicon glyphicon-remove small mio-remove" style="z-index: 1000"></span>

			<input name="desc" class="mio-inp addDesc" placeholder="请输入文件描述" style="margin-bottom: 20px;width: 300px"  type="text">
			<span class="glyphicon glyphicon-remove small mio-remove" style="z-index: 1000"></span>

			<%--select框--%>
			<select name="useType" class="selectBox" style="width: 300px;margin-bottom: 20px!important;"  data-placeholder="Select Your Options">
				<option value="">请选择</option>
			</select>

			<%--<input type="file" name="myfiles"/><br/>--%>
			<input name="size" class="mio-inp size" placeholder="文件大小" style="margin-top: 20px;margin-bottom: 20px;width: 300px"  type="hidden">
			...
			<input type="button" value="上传" class="mio-regLogin" id="addSoftbtn" style="margin-top: 20px;margin-bottom: 15px" />
