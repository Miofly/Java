...
<head>
    ...
    <!-- libraries -->
    <link rel="stylesheet" type="text/css" href="../../WEB-INF/jsp/detail/css/lib/font-awesome.css" />
    
    <!-- this page specific styles -->
    <link rel="stylesheet" href="../../WEB-INF/jsp/detail/css/compiled/personal-info.css" type="text/css" media="screen" />
            ...
            <div class="settings-wrapper" id="pad-wrapper">
                ...
                <div class="span3 avatar-box">
                    <div class="personal-image">
                        <img src="../../WEB-INF/jsp/detail/img/personal-info.png" class="avatar img-circle" />
