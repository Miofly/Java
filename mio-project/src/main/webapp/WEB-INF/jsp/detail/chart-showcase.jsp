...
<head>
    ...
    <!-- libraries -->
    <link href="../../WEB-INF/jsp/detail/css/lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css" />
    <link href="../../WEB-INF/jsp/detail/css/lib/font-awesome.css" type="text/css" rel="stylesheet" />
    <link href="../../WEB-INF/jsp/detail/css/lib/morris.css" type="text/css" rel="stylesheet" />
    
    <!-- this page specific styles -->
    <link rel="stylesheet" href="../../WEB-INF/jsp/detail/css/compiled/chart-showcase.css" type="text/css" media="screen" />
...
<body>
    ...
    <script src="../../../js/detail/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    <script src="../../../js/detail/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="../../../js/detail/jquery.flot.js"></script>
    <script src="../../../js/detail/jquery.flot.stack.js"></script>
    <script src="../../../js/detail/jquery.flot.resize.js"></script>
    <!-- morrisjs -->
    <script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <script src="../../../js/detail/morris.min.js"></script>
    <!-- call all plugins -->
