...
<style>
    ...
    .content{min-height: 410px!important;height: 590px;margin-bottom:0px;padding-bottom:0;margin-left: 150px}
    #sidebar-nav{width: 160px}
    #dashboard-menu .pointer{right: 16px}
    /*.content{min-height: 500px!important;height: 570px;margin-bottom:0px;padding-bottom:0}*/
            ...
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper products-table section">
                    <%--<div class="row-fluid head">--%>
                        <%--<div class="span12">--%>
                            <span id="stType" style="font-size: 18px;;position: relative;
                        font-style: normal;font-weight: 600;margin-left: 14px;color:rgb(41, 50, 58);">分类列表</span>
                        <%--</div>--%>
                    <%--</div>--%>
                    ...
                    <div id="datagrid1" class="mini-datagrid"
                            ...
                            margin-top: -100px!important;margin-left: -10px"
                            url="${basePath}sts/tab"
                            ajaxType="get" showHeader=true <%--title="全部软件"--%> <%--显示表头以及表头命名--%>
                            columns= columns <%--列的集合--%> pager="#pager1"
                            pageSize=50 sizeList=[50,100,150,700] <%--显示条数|页尺寸集合--%>
                       ...
                       >
                           <div property="columns">
                               ...
                               <div field="tabCode" width="100" allowSort="true"  align="center" visible="false" >软件类型</div>

                                <%--显示序号--%>
                                <%--<div type="indexcolumn" width="50" headerAlign="center" >序号</div>--%>
                                <%--显示checkbox   checkcolumn--%>
                                <div type="checkcolumn"></div>
                                    <%--<div field="tabName" width="100" allowSort="true"  align="center" visible="true" >软件类型</div>--%>
                                <div field="tabName" width="100" allowSort="true"  align="center" headerAlign="center" visible="true" >分类名称</div>
                                <div field="tabDesc" width="120" headerAlign="center"  align="center" allowSort="true">分类描述</div>
                                <div field="tabStatus" width="100" allowSort="true"  align="center" headerAlign="center" renderer="onUserstate">分类状态</div>
...
<script>
    ...
    function typeList(){
        $('.softType').change(function () {
            ...
            console.log(type);
            if(type!='all'){
                $('#stType').html($('.softType option:selected').html())
                grid.set({
    ...
    $('.addrow').click(function () {
        ...
        addPage('${basePath}st/addTab',"",500,600);
    });
    ...
    function show() {
        ...
        if(row!=null&&row!=undefined&&row!=''){
            console.log(row);
            addPage('${basePath}sts/queryByCodeId?codeId='+row.tabCode,'',500,630);
        }else {
            mntip("请选择修改对象",'info');
        }
    }
