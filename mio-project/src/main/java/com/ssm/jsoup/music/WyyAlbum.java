...
public class WyyAlbum {
    ...
    public static void readFile() {
        ...
        try {
            ...
            fr = new FileReader(new File("g://singerId.json"));
            BufferedReader br = new BufferedReader(fr);
            String line; // 定义一个字符串类型变量
            while ((line = br.readLine()) != null) {
                System.out.println("https://music.163.com/artist/album?id=" + line + "&limit=150&offset=0");
                getData("https://music.163.com/artist/album?id=" + line + "&limit=150&offset=0");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
