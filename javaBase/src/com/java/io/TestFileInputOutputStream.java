...
//		String dest = "C:\\Users\\shkstart\\Desktop\\2.avi";
        String src = "F:\\images\\003.jpg";
        String dest = "G:/io/dbcp2.txt";
        copyFile(src, dest);
    ...
    public void testFileInputOutputStream() {
        // 1.提供读入、写出的文件
        File file1 = new File("F:\\images\\zuihaode_women.jpg");
        File file2 = new File("G:\\io\\2.jpg");
        // 2.提供相应的流
        FileInputStream fis = null;
        FileOutputStream fos = null;
        try {
    ...
    public void testFileOutputStream() {
        ...
        // 输出的物理文件可以不存在，当执行过程中，若不存在，会自动的创建。
        // 若存在，会将原有的文件覆盖
        File file = new File("g:/io/hello3.txt");
    ...
    public void testFileInputStream3() { // abcdefgcde
        FileInputStream fis = null;
        try {
            File file = new File("g:/io/hello1.txt");
    ...
    public void testFileInputStream1() throws Exception {
        // 1.创建一个File类的对象。
        File file = new File("g:/io/hello12.txt");
        // 2.创建一个FileInputStream类的对象
